...
('date_of_birth', 'DOB (DD/MM/YYYY)', 'DATE', FALSE, TRUE, 3),
('gender', 'Gender', 'STRING', FALSE, TRUE, 4),
('apaar_id', 'APAAR ID (Automated Permanent Academic Account Registry)', 'STRING', FALSE, TRUE, 5),
('aadhaar_number', 'Student Aadhaar', 'STRING', FALSE, TRUE, 6),
('category', 'Category', 'STRING', FALSE, TRUE, 7),
('address', 'Address', 'STRING', FALSE, TRUE, 8),
('photo_url', 'Photo', 'FILE_URL', FALSE, TRUE, 9),
('previous_school_tc_url', 'Transfer Certificate (TC)', 'FILE_URL', FALSE, TRUE, 10),
('admission_class', 'Admission Class', 'STRING', FALSE, TRUE, 11),
('admission_date', 'Admission Date (DD/MM/YYYY)', 'DATE', FALSE, TRUE, 12),
...
('height_cm', 'Height (cm)', 'NUMBER', FALSE, TRUE, 18),
('weight_kg', 'Weight (kg)', 'NUMBER', FALSE, TRUE, 19),
('vision_check', 'Vision (6/6 or Diopters)', 'STRING', FALSE, TRUE, 20),
('character_cert_url', 'Character Certificate', 'FILE_URL', FALSE, TRUE, 21),
('fee_status', 'Fee Status', 'STRING', FALSE, TRUE, 22),
('attendance_percent', 'Attendance %', 'NUMBER', FALSE, TRUE, 23),
('udise_uploaded', 'UDISE Uploaded (Unified District Information System for Education)', 'BOOLEAN', FALSE, TRUE, 24),
